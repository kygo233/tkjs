...
export const pictureSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="m6,5.5a1.5,1.5 0 1 1 -3,0a1.5,1.5 0 0 1 3,0"/><path d="m2,1.06a2,2.13 0 0 0 -2,2.13l0,10.66a2,2.13 0 0 0 2,2.13l12,0a2,2.13 0 0 0 2,-2.13l0,-10.66a2,2.13 0 0 0 -2,-2.13l-12,0zm12,1.07a1,1.07 0 0 1 1,1.07l0,6.93l-3.78,-2.08a0.5,0.53 0 0 0 -0.57,0.11l-3.71,3.95l-2.66,-1.9a0.5,0.53 0 0 0 -0.63,0.07l-2.65,2.5l0,-9.59a1,1.07 0 0 1 1,-1.07l12,0z"/></svg>`;
